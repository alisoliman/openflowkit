      ...
      {(!isCopilot || canUndo) && (
        <div className="flex flex-wrap items-center justify-between gap-2">
          ...
          <button
            ...
            className="ml-auto inline-flex items-center gap-1.5 rounded-[var(--radius-sm)] px-2 py-1.5 text-xs font-medium text-[var(--brand-text)] hover:bg-[var(--brand-background)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-[var(--brand-primary)] disabled:cursor-not-allowed disabled:opacity-50"
          >
